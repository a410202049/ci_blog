...
AYN=0;//年份范围往后0年
function YMDselect(){
	this.SelY=document.getElementsByClassName(arguments[0])[0];
	this.SelM=document.getElementsByClassName(arguments[1])[0];
	this.SelD=document.getElementsByClassName(arguments[2])[0];
